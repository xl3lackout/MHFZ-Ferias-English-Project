...
i.type="button";
//昼夜
i.value="Day",i.title="昼で絞込み",i.style.marginLeft = "20px";
topDiv.appendChild(i.cloneNode(false));
i.value="Night",i.title="夜で絞込み",i.style.marginLeft = "0";
topDiv.appendChild(i.cloneNode(false));
topDiv=i=null;
...
function (evt) {
	...
	/*@end@*/
	if (t.tagName === "INPUT"){
		var tr=document.getElementsByTagName("tbody")[0].rows, N=tr.length,wk = t.value === "Night" ? "y" : "";
