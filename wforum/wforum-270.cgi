...
<body>
<div align="center" name="49" id="49">
<h1>掲示板</h1>
<hr width="95%">
...
<tr>
	...
	<td>タイトル</td>
	<td>： <b style="color:#dd0000">カフ反映されず</b></td>
</tr><tr>
	<td>投稿日</td>
	<td>： 2019/05/07(Tue) 01:22:15</td>
</tr><tr>
	<td>投稿者</td>
	<td>： <b>小部屋愛用者</b> </td>
</tr><tr>
...
<blockquote>2個あるうちの1個目に秘伝カフを選択時<br>もう一個目にカフを選択すると、データ保存時に秘伝カフ以外のカフのデータが〇（空きの状態）のまま保存され適用されないみたいです<br>PCカフでは再現されず、正常に保存されているみたいです<br>確認よろしくお願いします。</blockquote>

<hr width="95%">
<b style="text-indent:2em">- 関連一覧ツリー</b>
（▼ をクリックするとツリーを一括表示します）<br>
<p><ul>
<a href="wforum-158.cgi?mode=relate&no=49&page=50">▼</a> - <a href="wforum-270.cgi?no=49&reno=no&oya=49&mode=read&page=50">カフ反映されず</a> - <b>小部屋愛用者</b> 19/05/07-01:22 <b style="color:#dd0000">No.49</b>
</ul>
</p>
...
<option value="1">非表示
	...
	<td><b>タイトル</b></td>
	<td><input type="text" name="sub" size="38" value="Re: カフ反映されず" maxlength="20"></td>
</tr><tr>
	<td colspan="2"><b>メッセージ</b><br>
		<textarea name="message" rows="8" cols="62">
&gt; 2個あるうちの1個目に秘伝カフを選択時
&gt; もう一個目にカフを選択すると、データ保存時に秘伝カフ以外のカフのデータが〇（空きの状態）のまま保存され適用されないみたいです
&gt; PCカフでは再現されず、正常に保存されているみたいです
&gt; 確認よろしくお願いします。</textarea>
	</td>
</tr><tr>
	<td><b>参照先</b></td>
...
<!-- captcha_begin -->
	...
	<td><input type="text" name="captcha" size="8" style="ime-mode:inactive" value="" maxlength="8">
		（右画像の数字を入力）
		<img src="captcha-174.cgi?c02597717c7869554a1114b042c7b14f" class="capt" alt="投稿キー">
		<input type="hidden" name="str_crypt" value="c02597717c7869554a1114b042c7b14f">
	</td>
<!-- captcha_end -->
</tr>
</table>
