...
<body>
<div align="center" name="64" id="64">
<h1>掲示板</h1>
<hr width="95%">
...
<tr>
	...
	<td>タイトル</td>
	<td>： <b style="color:#dd0000">ありがとうございました</b></td>
</tr><tr>
	<td>投稿日</td>
	<td>： 2019/06/22(Sat) 07:00:12</td>
</tr><tr>
	<td>投稿者</td>
	<td>： <b>２鯖民</b> </td>
</tr><tr>
...
<blockquote>ｍｈｆを起動している時は必ず一緒に開いていました。<br>大げさではなく私の人生で一番開いたウェブサイトが小部屋さんかもしれません。<br>スキルシミュは小部屋さんで手動でやるのが好きでした。<br>そして肉質が覚えられなかった私は小部屋さんがなければ完全に地雷として晒されているところでした。<br>本当に感謝してもしきれません。お疲れ様でした。そしてどうかお元気で。</blockquote>

<hr width="95%">
<b style="text-indent:2em">- 関連一覧ツリー</b>
（▼ をクリックするとツリーを一括表示します）<br>
<p><ul>
<a href="wforum-129.cgi?mode=relate&no=64&page=40">▼</a> - <a href="wforum-255.cgi?no=64&reno=no&oya=64&mode=read&page=40">ありがとうございました</a> - <b>２鯖民</b> 19/06/22-07:00 <b style="color:#dd0000">No.64</b>
</ul>
</p>
...
<input type="hidden" name="oya" value="64">
<blockquote>
...
<option value="1">非表示
	...
	<td><b>タイトル</b></td>
	<td><input type="text" name="sub" size="38" value="Re: ありがとうございました" maxlength="20"></td>
</tr><tr>
	<td colspan="2"><b>メッセージ</b><br>
		<textarea name="message" rows="8" cols="62">
&gt; ｍｈｆを起動している時は必ず一緒に開いていました。
&gt; 大げさではなく私の人生で一番開いたウェブサイトが小部屋さんかもしれません。
&gt; スキルシミュは小部屋さんで手動でやるのが好きでした。
&gt; そして肉質が覚えられなかった私は小部屋さんがなければ完全に地雷として晒されているところでした。
&gt; 本当に感謝してもしきれません。お疲れ様でした。そしてどうかお元気で。</textarea>
	</td>
</tr><tr>
	<td><b>参照先</b></td>
...
<!-- captcha_begin -->
	...
	<td><input type="text" name="captcha" size="8" style="ime-mode:inactive" value="" maxlength="8">
		（右画像の数字を入力）
		<img src="captcha-159.cgi?c3239271767b69554a1114b042c7b34b" class="capt" alt="投稿キー">
		<input type="hidden" name="str_crypt" value="c3239271767b69554a1114b042c7b34b">
	</td>
<!-- captcha_end -->
</tr>
</table>
