...
<body>
<div align="center" name="108" id="108">
<h1>掲示板</h1>
<hr width="95%">
...
<tr>
	...
	<td>タイトル</td>
	<td>： <b style="color:#dd0000">あった</b></td>
</tr><tr>
	<td>投稿日</td>
	<td>： 2020/10/24(Sat) 01:32:38</td>
</tr><tr>
	<td>投稿者</td>
	<td>： <b>匿名</b> </td>
</tr><tr>
...
<blockquote>まだこのサイト残ってたんですね。いつまでも残っていてほしいです。MHFが無くなってから熱中出来るゲームがなく、空虚な日々を過ごしています……</blockquote>

<hr width="95%">
<b style="text-indent:2em">- 関連一覧ツリー</b>
（▼ をクリックするとツリーを一括表示します）<br>
<p><ul>
<a href="wforum-12.cgi?mode=relate&no=108&page=0">▼</a> - <a href="wforum-51.cgi?no=108&reno=no&oya=108&mode=read&page=0">あった</a> - <b>匿名</b> 20/10/24-01:32 <b style="color:#dd0000">No.108</b>
</ul>
</p>
...
<input type="hidden" name="oya" value="108">
<blockquote>
...
<option value="1">非表示
	...
	<td><b>タイトル</b></td>
	<td><input type="text" name="sub" size="38" value="Re: あった" maxlength="20"></td>
</tr><tr>
	<td colspan="2"><b>メッセージ</b><br>
		<textarea name="message" rows="8" cols="62">
&gt; まだこのサイト残ってたんですね。いつまでも残っていてほしいです。MHFが無くなってから熱中出来るゲームがなく、空虚な日々を過ごしています……</textarea>
	</td>
</tr><tr>
	<td><b>参照先</b></td>
...
<!-- captcha_begin -->
	...
	<td><input type="text" name="captcha" size="8" style="ime-mode:inactive" value="" maxlength="8">
		（右画像の数字を入力）
		<img src="captcha-28.cgi?c72c927d717169554a1114b34ac5b449" class="capt" alt="投稿キー">
		<input type="hidden" name="str_crypt" value="c72c927d717169554a1114b34ac5b449">
	</td>
<!-- captcha_end -->
</tr>
</table>
