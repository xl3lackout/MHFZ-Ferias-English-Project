...
<body>
<div align="center" name="72" id="72">
<h1>掲示板</h1>
<hr width="95%">
...
<blockquote>　「不退」を今まで組み入れたことが、なかったので急に不退珠を貰えても困っていたので、スキルシミュレーターは非常に助かりました。<br><br>　最後の最後で極み襲うボガバドルムを撃退させることができました。感謝します。<br><br>　何年にも渡るデータの更新、本当にありがとうございました。</blockquote>

<hr width="95%">
<b style="text-indent:2em">- 関連一覧ツリー</b>
（▼ をクリックするとツリーを一括表示します）<br>
<p><ul>
<a href="wforum-121.cgi?mode=relate&no=72&page=30">▼</a> - <a href="wforum-251.cgi?no=72&reno=no&oya=72&mode=read&page=30">ありがとうございました</a> - <b>jeans一同</b> 19/12/18-00:22 <b style="color:#dd0000">No.72</b>
</ul>
</p>
...
&gt; 　「不退」を今まで組み入れたことが、なかったので急に不退珠を貰えても困っていたので、スキルシミュレーターは非常に助かりました。
&gt; 
&gt; 　最後の最後で極み襲うボガバドルムを撃退させることができました。感謝します。
&gt; 
&gt; 　何年にも渡るデータの更新、本当にありがとうございました。</textarea>
	</td>
</tr><tr>
	<td><b>参照先</b></td>
...
<!-- captcha_begin -->
	...
	<td><input type="text" name="captcha" size="8" style="ime-mode:inactive" value="" maxlength="8">
		（右画像の数字を入力）
		<img src="captcha-155.cgi?ce22997e747e69554a1114b042c7b34e" class="capt" alt="投稿キー">
		<input type="hidden" name="str_crypt" value="ce22997e747e69554a1114b042c7b34e">
	</td>
<!-- captcha_end -->
</tr>
</table>
