...
<body>
<div align="center" name="40" id="40">
<h1>掲示板</h1>
<hr width="95%">
...
<tr>
	...
	<td>タイトル</td>
	<td>： <b style="color:#dd0000">ハルドz</b></td>
</tr><tr>
	<td>投稿日</td>
	<td>： 2019/04/29(Mon) 16:02:19</td>
</tr><tr>
	<td>投稿者</td>
	<td>： <b>らいおん</b> </td>
</tr><tr>
...
<blockquote>選択すると、G防具が出てきます</blockquote>

<hr width="95%">
<b style="text-indent:2em">- 関連一覧ツリー</b>
（▼ をクリックするとツリーを一括表示します）<br>
<p><ul>
<a href="wforum-176.cgi?mode=relate&no=40&page=60">▼</a> - <a href="wforum-282.cgi?no=40&reno=no&oya=40&mode=read&page=60">ハルドz</a> - <b>らいおん</b> 19/04/29-16:02 <b style="color:#dd0000">No.40</b>
<ul>
<li><a href="wforum-283.cgi?no=42&reno=40&oya=40&mode=read&page=60">Re: ハルドz</a> - <b>フェリアス</b> 19/04/29-17:24  <span style="color:#008000">No.42</span>
</li></ul>
</ul>
</p>
...
<input type="hidden" name="oya" value="40">
<blockquote>
...
<option value="1">非表示
	...
	<td><b>タイトル</b></td>
	<td><input type="text" name="sub" size="38" value="Re: ハルドz" maxlength="20"></td>
</tr><tr>
	<td colspan="2"><b>メッセージ</b><br>
		<textarea name="message" rows="8" cols="62">
&gt; 選択すると、G防具が出てきます</textarea>
	</td>
</tr><tr>
	<td><b>参照先</b></td>
...
<!-- captcha_begin -->
	...
	<td><input type="text" name="captcha" size="8" style="ime-mode:inactive" value="" maxlength="8">
		（右画像の数字を入力）
		<img src="captcha-100.cgi?cf2d9979747f69554a1114b34ac4b64e" class="capt" alt="投稿キー">
		<input type="hidden" name="str_crypt" value="cf2d9979747f69554a1114b34ac4b64e">
	</td>
<!-- captcha_end -->
</tr>
</table>
