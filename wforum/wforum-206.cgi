...
<body>
<div align="center" name="12" id="12">
<h1>掲示板</h1>
<hr width="95%">
...
<tr>
	...
	<td>タイトル</td>
	<td>： <b style="color:#dd0000">Re: 不具合？</b></td>
</tr><tr>
	<td>投稿日</td>
	<td>： 2018/09/06(Thu) 01:27:25</td>
</tr><tr>
	<td>投稿者</td>
	<td>： <b>フェリアス</b> </td>
</tr><tr>
...
<blockquote><font color="#804000">&gt; 武器一覧のページで、辿異スキルでソートすると何も表示されなくなってしまいます</font><br>修正しました</blockquote>

<hr width="95%">
<b style="text-indent:2em">- 関連一覧ツリー</b>
（▼ をクリックするとツリーを一括表示します）<br>
<p><ul>
<a href="wforum-204.cgi?mode=relate&no=11&page=70">▼</a> - <a href="wforum-298.cgi?no=11&reno=no&oya=11&mode=read&page=70">不具合？</a> - <b>AA</b> 18/09/05-15:59 <span style="color:#008000">No.11</span>
<ul>
<li><a href="wforum-299.cgi?no=12&reno=11&oya=11&mode=read&page=70">Re: 不具合？</a> - <b>フェリアス</b> 18/09/06-01:27  <b style="color:#dd0000">No.12</b>
</li></ul>
</ul>
</p>
...
<input type="hidden" name="oya" value="11">
<blockquote>
...
<option value="1">非表示
	...
	<td><b>タイトル</b></td>
	<td><input type="text" name="sub" size="38" value="Re^2: 不具合？" maxlength="20"></td>
</tr><tr>
	<td colspan="2"><b>メッセージ</b><br>
		<textarea name="message" rows="8" cols="62">
&gt; &gt; 武器一覧のページで、辿異スキルでソートすると何も表示されなくなってしまいます
&gt; 修正しました</textarea>
	</td>
</tr><tr>
	<td><b>参照先</b></td>
...
<!-- captcha_begin -->
	...
	<td><input type="text" name="captcha" size="8" style="ime-mode:inactive" value="" maxlength="8">
		（右画像の数字を入力）
		<img src="captcha-117.cgi?c02794707c7b69554a1114b34ac4b548" class="capt" alt="投稿キー">
		<input type="hidden" name="str_crypt" value="c02794707c7b69554a1114b34ac4b548">
	</td>
<!-- captcha_end -->
</tr>
</table>
