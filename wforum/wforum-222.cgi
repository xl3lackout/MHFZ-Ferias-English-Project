...
<body>
<div align="center" name="101" id="101">
<h1>掲示板</h1>
<hr width="95%">
...
<tr>
	...
	<td>タイトル</td>
	<td>： <b style="color:#dd0000">お疲れさまでした</b></td>
</tr><tr>
	<td>投稿日</td>
	<td>： 2020/01/14(Tue) 23:13:23</td>
</tr><tr>
	<td>投稿者</td>
	<td>： <b>D</b> </td>
</tr><tr>
...
<blockquote>お疲れさまでした。今までお世話になりました。このサイトは残すのでしょうか？MHFの思い出を振り返るために、たまに覗きに来たいと思います</blockquote>

<hr width="95%">
<b style="text-indent:2em">- 関連一覧ツリー</b>
（▼ をクリックするとツリーを一括表示します）<br>
<p><ul>
<a href="wforum-62.cgi?mode=relate&no=101&page=10">▼</a> - <a href="wforum-222.cgi?no=101&reno=no&oya=101&mode=read&page=10">お疲れさまでした</a> - <b>D</b> 20/01/14-23:13 <b style="color:#dd0000">No.101</b>
</ul>
</p>
...
<input type="hidden" name="no" value="101">
<input type="hidden" name="oya" value="101">
<blockquote>
...
<option value="1">非表示
	...
	<td><b>タイトル</b></td>
	<td><input type="text" name="sub" size="38" value="Re: お疲れさまでした" maxlength="20"></td>
</tr><tr>
	<td colspan="2"><b>メッセージ</b><br>
		<textarea name="message" rows="8" cols="62">
&gt; お疲れさまでした。今までお世話になりました。このサイトは残すのでしょうか？MHFの思い出を振り返るために、たまに覗きに来たいと思います</textarea>
	</td>
</tr><tr>
	<td><b>参照先</b></td>
...
<!-- captcha_begin -->
	...
	<td><input type="text" name="captcha" size="8" style="ime-mode:inactive" value="" maxlength="8">
		（右画像の数字を入力）
		<img src="captcha-126.cgi?ce2594707d7169554a1114b042c7b746" class="capt" alt="投稿キー">
		<input type="hidden" name="str_crypt" value="ce2594707d7169554a1114b042c7b746">
	</td>
<!-- captcha_end -->
</tr>
</table>
