...
<body>
<div align="center" name="88" id="88">
<h1>掲示板</h1>
<hr width="95%">
...
<tr>
	...
	<td>タイトル</td>
	<td>： <b style="color:#dd0000">ありがとうござました</b></td>
</tr><tr>
	<td>投稿日</td>
	<td>： 2019/12/19(Thu) 00:16:09</td>
</tr><tr>
	<td>投稿者</td>
	<td>： <b>衝撃のダイ</b> </td>
</tr><tr>
...
<blockquote>非公式ながらこのサイトが存在しなかったらゲームが成り立たないってくらいにお世話になっておりました、大感謝です</blockquote>

<hr width="95%">
<b style="text-indent:2em">- 関連一覧ツリー</b>
（▼ をクリックするとツリーを一括表示します）<br>
<p><ul>
<a href="wforum-89.cgi?mode=relate&no=88&page=20">▼</a> - <a href="wforum-235.cgi?no=88&reno=no&oya=88&mode=read&page=20">ありがとうござました</a> - <b>衝撃のダイ</b> 19/12/19-00:16 <b style="color:#dd0000">No.88</b>
</ul>
</p>
...
<input type="hidden" name="no" value="88">
<input type="hidden" name="oya" value="88">
<blockquote>
...
<option value="1">非表示
	...
	<td><b>タイトル</b></td>
	<td><input type="text" name="sub" size="38" value="Re: ありがとうござました" maxlength="20"></td>
</tr><tr>
	<td colspan="2"><b>メッセージ</b><br>
		<textarea name="message" rows="8" cols="62">
&gt; 非公式ながらこのサイトが存在しなかったらゲームが成り立たないってくらいにお世話になっておりました、大感謝です</textarea>
	</td>
</tr><tr>
	<td><b>参照先</b></td>
...
<!-- captcha_begin -->
	...
	<td><input type="text" name="captcha" size="8" style="ime-mode:inactive" value="" maxlength="8">
		（右画像の数字を入力）
		<img src="captcha-139.cgi?c026977c757969554a1114b042c7b54f" class="capt" alt="投稿キー">
		<input type="hidden" name="str_crypt" value="c026977c757969554a1114b042c7b54f">
	</td>
<!-- captcha_end -->
</tr>
</table>
