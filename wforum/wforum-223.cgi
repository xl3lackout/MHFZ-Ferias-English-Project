...
<body>
<div align="center" name="100" id="100">
<h1>掲示板</h1>
<hr width="95%">
...
<tr>
	...
	<td>投稿日</td>
	<td>： 2020/01/09(Thu) 20:55:06</td>
</tr><tr>
	<td>投稿者</td>
	<td>： <b>ひかる</b> </td>
</tr><tr>
	<td>参照先</td>
	<td>： <a href="http://blog.livedoor.jp/mhfgland/" target="_top" class="num">http://blog.livedoor.jp/mhfgland/</a></td>
</tr>
</table>
<blockquote>ＭＨＦをやるためには猟団ＦｒｅｅＤｏｍの小道具部屋様は本当に必須でした。<br>多くの情報をありがとうございました。<br>お世話になりました!</blockquote>

<hr width="95%">
<b style="text-indent:2em">- 関連一覧ツリー</b>
（▼ をクリックするとツリーを一括表示します）<br>
<p><ul>
<a href="wforum-64.cgi?mode=relate&no=100&page=10">▼</a> - <a href="wforum-223.cgi?no=100&reno=no&oya=100&mode=read&page=10">ありがとうございました！</a> - <b>ひかる</b> 20/01/09-20:55 <b style="color:#dd0000">No.100</b>
</ul>
</p>
...
<input type="hidden" name="oya" value="100">
<blockquote>
...
&gt; ＭＨＦをやるためには猟団ＦｒｅｅＤｏｍの小道具部屋様は本当に必須でした。
&gt; 多くの情報をありがとうございました。
&gt; お世話になりました!</textarea>
	</td>
</tr><tr>
...
<!-- captcha_begin -->
	...
	<td><input type="text" name="captcha" size="8" style="ime-mode:inactive" value="" maxlength="8">
		（右画像の数字を入力）
		<img src="captcha-127.cgi?c1249879767e69554a1114b042c7b747" class="capt" alt="投稿キー">
		<input type="hidden" name="str_crypt" value="c1249879767e69554a1114b042c7b747">
	</td>
<!-- captcha_end -->
</tr>
</table>
