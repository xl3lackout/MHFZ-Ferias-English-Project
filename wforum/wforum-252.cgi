...
<body>
<div align="center" name="71" id="71">
<h1>掲示板</h1>
<hr width="95%">
...
<tr>
	...
	<td>タイトル</td>
	<td>： <b style="color:#dd0000">長い間ありがとうございました。</b></td>
</tr><tr>
	<td>投稿日</td>
	<td>： 2019/12/03(Tue) 01:09:18</td>
</tr><tr>
	<td>投稿者</td>
	<td>： <b>静電</b> </td>
</tr><tr>
...
<blockquote>MHFを楽しくプレイできたのは小部屋さんの存在がとても大きかったです。<br>特にスキルシミュはかなーーり長時間ポチポチポチポチいろんな組み合わせを確認してました（笑）<br>楽しいと思える時間を与えてくれてありがとうございました！</blockquote>

<hr width="95%">
<b style="text-indent:2em">- 関連一覧ツリー</b>
（▼ をクリックするとツリーを一括表示します）<br>
<p><ul>
<a href="wforum-123.cgi?mode=relate&no=71&page=40">▼</a> - <a href="wforum-252.cgi?no=71&reno=no&oya=71&mode=read&page=40">長い間ありがとうございました。</a> - <b>静電</b> 19/12/03-01:09 <b style="color:#dd0000">No.71</b>
</ul>
</p>
...
<input type="hidden" name="oya" value="71">
<blockquote>
...
<option value="1">非表示
	...
	<td><b>タイトル</b></td>
	<td><input type="text" name="sub" size="38" value="Re: 長い間ありがとうございました。" maxlength="20"></td>
</tr><tr>
	<td colspan="2"><b>メッセージ</b><br>
		<textarea name="message" rows="8" cols="62">
&gt; MHFを楽しくプレイできたのは小部屋さんの存在がとても大きかったです。
&gt; 特にスキルシミュはかなーーり長時間ポチポチポチポチいろんな組み合わせを確認してました（笑）
&gt; 楽しいと思える時間を与えてくれてありがとうございました！</textarea>
	</td>
</tr><tr>
	<td><b>参照先</b></td>
...
<!-- captcha_begin -->
	...
	<td><input type="text" name="captcha" size="8" style="ime-mode:inactive" value="" maxlength="8">
		（右画像の数字を入力）
		<img src="captcha-156.cgi?c0219870777a69554a1114b042c7b34f" class="capt" alt="投稿キー">
		<input type="hidden" name="str_crypt" value="c0219870777a69554a1114b042c7b34f">
	</td>
<!-- captcha_end -->
</tr>
</table>
