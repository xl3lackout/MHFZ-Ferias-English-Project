...
<body>
<div align="center" name="109" id="109">
<h1>掲示板</h1>
<hr width="95%">
...
<tr>
	...
	<td>タイトル</td>
	<td>： <b style="color:#dd0000">MHFありがとう</b></td>
</tr><tr>
	<td>投稿日</td>
	<td>： 2020/11/08(Sun) 00:16:55</td>
</tr><tr>
	<td>投稿者</td>
	<td>： <b>もこう</b> &nbsp; &lt;<a href="mailto:mokou.mhfz@gmail.com" class="num">mokou.mhfz@gmail.com</a>&gt;</td>
</tr><tr>
	<td>参照先</td>
	<td>： </td>
</tr>
</table>
<blockquote>MHFに関してです<br>朗報があります、皆のために<br>あなたの力を貸してください<br>良ければ連絡ください</blockquote>

<hr width="95%">
<b style="text-indent:2em">- 関連一覧ツリー</b>
（▼ をクリックするとツリーを一括表示します）<br>
<p><ul>
<a href="wforum-10.cgi?mode=relate&no=109&page=0">▼</a> - <a href="wforum-50.cgi?no=109&reno=no&oya=109&mode=read&page=0">MHFありがとう</a> - <b>もこう</b> 20/11/08-00:16 <b style="color:#dd0000">No.109</b>
</ul>
</p>
...
<input type="hidden" name="oya" value="109">
<blockquote>
...
<option value="1">非表示
	...
	<td><b>タイトル</b></td>
	<td><input type="text" name="sub" size="38" value="Re: MHFありがとう" maxlength="20"></td>
</tr><tr>
...
<!-- captcha_begin -->
	...
	<td><input type="text" name="captcha" size="8" style="ime-mode:inactive" value="" maxlength="8">
		（右画像の数字を入力）
		<img src="captcha-27.cgi?ce20967d717869554a1114b34ac5b448" class="capt" alt="投稿キー">
		<input type="hidden" name="str_crypt" value="ce20967d717869554a1114b34ac5b448">
	</td>
<!-- captcha_end -->
</tr>
</table>
