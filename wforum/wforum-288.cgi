...
<body>
<div align="center" name="25" id="25">
<h1>掲示板</h1>
<hr width="95%">
...
<tr>
	...
	<td>タイトル</td>
	<td>： <b style="color:#dd0000">スキルシミュについてですが</b></td>
</tr><tr>
	<td>投稿日</td>
	<td>： 2018/12/29(Sat) 02:52:18</td>
</tr><tr>
	<td>投稿者</td>
	<td>： <b>宮の衆</b> </td>
</tr><tr>
...
<blockquote>スキルシミュに辿異グラビ防具のデータが無いようなのですが</blockquote>

<hr width="95%">
<b style="text-indent:2em">- 関連一覧ツリー</b>
（▼ をクリックするとツリーを一括表示します）<br>
<p><ul>
<a href="wforum-185.cgi?mode=relate&no=25&page=60">▼</a> - <a href="wforum-288.cgi?no=25&reno=no&oya=25&mode=read&page=60">スキルシミュについてですが</a> - <b>宮の衆</b> 18/12/29-02:52 <b style="color:#dd0000">No.25</b>
</ul>
</p>
...
<option value="1">非表示
	...
	<td><b>タイトル</b></td>
	<td><input type="text" name="sub" size="38" value="Re: スキルシミュについてですが" maxlength="20"></td>
</tr><tr>
	<td colspan="2"><b>メッセージ</b><br>
		<textarea name="message" rows="8" cols="62">
&gt; スキルシミュに辿異グラビ防具のデータが無いようなのですが</textarea>
	</td>
</tr><tr>
	<td><b>参照先</b></td>
...
<!-- captcha_begin -->
	...
	<td><input type="text" name="captcha" size="8" style="ime-mode:inactive" value="" maxlength="8">
		（右画像の数字を入力）
		<img src="captcha-192.cgi?ce269671767e69554a1114b042c7bf4f" class="capt" alt="投稿キー">
		<input type="hidden" name="str_crypt" value="ce269671767e69554a1114b042c7bf4f">
	</td>
<!-- captcha_end -->
</tr>
</table>
