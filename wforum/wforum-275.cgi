...
<body>
<div align="center" name="47" id="47">
<h1>掲示板</h1>
<hr width="95%">
...
<tr>
	...
	<td>タイトル</td>
	<td>： <b style="color:#dd0000">Re: シジルの数値</b></td>
</tr><tr>
	<td>投稿日</td>
	<td>： 2019/04/29(Mon) 17:33:54</td>
</tr><tr>
	<td>投稿者</td>
	<td>： <b>フェリアス </b> </td>
</tr><tr>
...
<blockquote>この状態のデータしかないので変更できません、<br>おそらく内部でごちゃごちゃ判定してそうですが<br>こちらでは知ることができません。</blockquote>

<hr width="95%">
<b style="text-indent:2em">- 関連一覧ツリー</b>
（▼ をクリックするとツリーを一括表示します）<br>
<p><ul>
<a href="wforum-164.cgi?mode=relate&no=31&page=50">▼</a> - <a href="wforum-274.cgi?no=31&reno=no&oya=31&mode=read&page=50">シジルの数値</a> - <b>とあるハンター</b> 19/03/12-12:55 <span style="color:#008000">No.31</span>
<ul>
<li><a href="wforum-275.cgi?no=47&reno=31&oya=31&mode=read&page=50">Re: シジルの数値</a> - <b>フェリアス </b> 19/04/29-17:33  <b style="color:#dd0000">No.47</b>
</li></ul>
</ul>
</p>
...
<option value="1">非表示
	...
	<td><b>タイトル</b></td>
	<td><input type="text" name="sub" size="38" value="Re^2: シジルの数値" maxlength="20"></td>
</tr><tr>
	<td colspan="2"><b>メッセージ</b><br>
		<textarea name="message" rows="8" cols="62">
&gt; この状態のデータしかないので変更できません、
&gt; おそらく内部でごちゃごちゃ判定してそうですが
&gt; こちらでは知ることができません。</textarea>
	</td>
</tr><tr>
	<td><b>参照先</b></td>
...
<!-- captcha_begin -->
	...
	<td><input type="text" name="captcha" size="8" style="ime-mode:inactive" value="" maxlength="8">
		（右画像の数字を入力）
		<img src="captcha-179.cgi?ce27997c727a69554a1114b042c7b148" class="capt" alt="投稿キー">
		<input type="hidden" name="str_crypt" value="ce27997c727a69554a1114b042c7b148">
	</td>
<!-- captcha_end -->
</tr>
</table>
