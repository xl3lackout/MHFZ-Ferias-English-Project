...
<body>
<div align="center" name="111" id="111">
<h1>掲示板</h1>
<hr width="95%">
...
<tr>
	...
	<td>タイトル</td>
	<td>： <b style="color:#dd0000">気になったので</b></td>
</tr><tr>
	<td>投稿日</td>
	<td>： 2021/05/13(Thu) 16:39:09</td>
</tr><tr>
	<td>投稿者</td>
	<td>： <b>ごん</b> </td>
</tr><tr>
...
<blockquote>諦めていた昔の装備で装飾品の入れ替え試しを実行<br><br>やってみたら案外簡単に作成<br><br>当時の自分を恨みながらも悩みが解消されて満足しました<br><br>改めて小部屋さんに感謝です</blockquote>

<hr width="95%">
<b style="text-indent:2em">- 関連一覧ツリー</b>
（▼ をクリックするとツリーを一括表示します）<br>
<p><ul>
<a href="wforum-6.cgi?mode=relate&no=111&page=0">▼</a> - <a href="wforum-48.cgi?no=111&reno=no&oya=111&mode=read&page=0">気になったので</a> - <b>ごん</b> 21/05/13-16:39 <b style="color:#dd0000">No.111</b>
</ul>
</p>
...
<input type="hidden" name="oya" value="111">
<blockquote>
...
<option value="1">非表示
	...
	<td><b>タイトル</b></td>
	<td><input type="text" name="sub" size="38" value="Re: 気になったので" maxlength="20"></td>
</tr><tr>
	<td colspan="2"><b>メッセージ</b><br>
		<textarea name="message" rows="8" cols="62">
&gt; 諦めていた昔の装備で装飾品の入れ替え試しを実行
&gt; 
&gt; やってみたら案外簡単に作成
&gt; 
&gt; 当時の自分を恨みながらも悩みが解消されて満足しました
&gt; 
&gt; 改めて小部屋さんに感謝です</textarea>
	</td>
</tr><tr>
	<td><b>参照先</b></td>
...
<!-- captcha_begin -->
	...
	<td><input type="text" name="captcha" size="8" style="ime-mode:inactive" value="" maxlength="8">
		（右画像の数字を入力）
		<img src="captcha-2.cgi?c72494707c7b69554a1114b34bc5b54d" class="capt" alt="投稿キー">
		<input type="hidden" name="str_crypt" value="c72494707c7b69554a1114b34bc5b54d">
	</td>
<!-- captcha_end -->
</tr>
</table>
