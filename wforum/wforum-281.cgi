...
<body>
<div align="center" name="43" id="43">
<h1>掲示板</h1>
<hr width="95%">
...
<tr>
	...
	<td>タイトル</td>
	<td>： <b style="color:#dd0000">Re: テキスト読み込み時</b></td>
</tr><tr>
	<td>投稿日</td>
	<td>： 2019/04/29(Mon) 17:26:44</td>
</tr><tr>
	<td>投稿者</td>
	<td>： <b>フェリアス </b> </td>
</tr><tr>
...
<blockquote>修正しました</blockquote>

<hr width="95%">
<b style="text-indent:2em">- 関連一覧ツリー</b>
（▼ をクリックするとツリーを一括表示します）<br>
<p><ul>
<a href="wforum-173.cgi?mode=relate&no=38&page=60">▼</a> - <a href="wforum-280.cgi?no=38&reno=no&oya=38&mode=read&page=60">テキスト読み込み時</a> - <b>参照でデータ読み込むと・・・</b> 19/04/29-10:46 <span style="color:#008000">No.38</span>
<ul>
<li><a href="wforum-281.cgi?no=43&reno=38&oya=38&mode=read&page=60">Re: テキスト読み込み時</a> - <b>フェリアス </b> 19/04/29-17:26  <b style="color:#dd0000">No.43</b>
</li></ul>
</ul>
</p>
...
<option value="1">非表示
	...
	<td><b>タイトル</b></td>
	<td><input type="text" name="sub" size="38" value="Re^2: テキスト読み込み時" maxlength="20"></td>
</tr><tr>
...
<!-- captcha_begin -->
	...
	<td><input type="text" name="captcha" size="8" style="ime-mode:inactive" value="" maxlength="8">
		（右画像の数字を入力）
		<img src="captcha-185.cgi?c623967d777c69554a1114b042c7b04d" class="capt" alt="投稿キー">
		<input type="hidden" name="str_crypt" value="c623967d777c69554a1114b042c7b04d">
	</td>
<!-- captcha_end -->
</tr>
</table>
