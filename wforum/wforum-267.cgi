...
<body>
<div align="center" name="53" id="53">
<h1>掲示板</h1>
<hr width="95%">
...
<blockquote>引退してから何年にもなりますが小部屋様のおかげでMHFを楽しくプレイすることができました。ありがとうございました！</blockquote>

<hr width="95%">
<b style="text-indent:2em">- 関連一覧ツリー</b>
（▼ をクリックするとツリーを一括表示します）<br>
<p><ul>
<a href="wforum-152.cgi?mode=relate&no=53&page=50">▼</a> - <a href="wforum-267.cgi?no=53&reno=no&oya=53&mode=read&page=50">お世話になりました</a> - <b>MHF元3鯖民</b> 19/06/19-20:44 <b style="color:#dd0000">No.53</b>
</ul>
</p>
...
<input type="hidden" name="oya" value="53">
<blockquote>
...
&gt; 引退してから何年にもなりますが小部屋様のおかげでMHFを楽しくプレイすることができました。ありがとうございました！</textarea>
	</td>
</tr><tr>
	<td><b>参照先</b></td>
...
<!-- captcha_begin -->
	...
	<td><input type="text" name="captcha" size="8" style="ime-mode:inactive" value="" maxlength="8">
		（右画像の数字を入力）
		<img src="captcha-171.cgi?c4269978757b69554a1114b042c7b246" class="capt" alt="投稿キー">
		<input type="hidden" name="str_crypt" value="c4269978757b69554a1114b042c7b246">
	</td>
<!-- captcha_end -->
</tr>
</table>
