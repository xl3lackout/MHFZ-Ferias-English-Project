...
<body>
<div align="center" name="23" id="23">
<h1>掲示板</h1>
<hr width="95%">
...
<tr>
	...
	<td>タイトル</td>
	<td>： <b style="color:#dd0000">SSについて</b></td>
</tr><tr>
	<td>投稿日</td>
	<td>： 2018/11/30(Fri) 17:28:55</td>
</tr><tr>
	<td>投稿者</td>
	<td>： <b>あき。</b> </td>
</tr><tr>
...
<blockquote>スキルシミュレータに要望です。<br>可能でしたら、任意のスキルを搭載できる仮装備を実装していただえるとさいわいです。</blockquote>

<hr width="95%">
<b style="text-indent:2em">- 関連一覧ツリー</b>
（▼ をクリックするとツリーを一括表示します）<br>
<p><ul>
<a href="wforum-189.cgi?mode=relate&no=23&page=60">▼</a> - <a href="wforum-290.cgi?no=23&reno=no&oya=23&mode=read&page=60">SSについて</a> - <b>あき。</b> 18/11/30-17:28 <b style="color:#dd0000">No.23</b>
</ul>
</p>
...
<input type="hidden" name="oya" value="23">
<blockquote>
...
<option value="1">非表示
	...
	<td><b>タイトル</b></td>
	<td><input type="text" name="sub" size="38" value="Re: SSについて" maxlength="20"></td>
</tr><tr>
	<td colspan="2"><b>メッセージ</b><br>
		<textarea name="message" rows="8" cols="62">
&gt; スキルシミュレータに要望です。
&gt; 可能でしたら、任意のスキルを搭載できる仮装備を実装していただえるとさいわいです。</textarea>
	</td>
</tr><tr>
	<td><b>参照先</b></td>
...
<!-- captcha_begin -->
	...
	<td><input type="text" name="captcha" size="8" style="ime-mode:inactive" value="" maxlength="8">
		（右画像の数字を入力）
		<img src="captcha-108.cgi?c624957a757d69554a1114b34ac4b649" class="capt" alt="投稿キー">
		<input type="hidden" name="str_crypt" value="c624957a757d69554a1114b34ac4b649">
	</td>
<!-- captcha_end -->
</tr>
</table>
