...
<body>
<div align="center" name="57" id="57">
<h1>掲示板</h1>
<hr width="95%">
...
<blockquote>ここでいっぱいシミュしました<br>肉質見ながら戦ってました<br><br>大変‥大変お世話になりました‥ありがとうございました！</blockquote>

<hr width="95%">
<b style="text-indent:2em">- 関連一覧ツリー</b>
（▼ をクリックするとツリーを一括表示します）<br>
<p><ul>
<a href="wforum-143.cgi?mode=relate&no=57&page=50">▼</a> - <a href="wforum-262.cgi?no=57&reno=no&oya=57&mode=read&page=50">おつかれさまでした</a> - <b>秘境から</b> 19/06/20-10:49 <b style="color:#dd0000">No.57</b>
</ul>
</p>
...
<input type="hidden" name="oya" value="57">
<blockquote>
...
&gt; 肉質見ながら戦ってました
&gt; 
&gt; 大変‥大変お世話になりました‥ありがとうございました！</textarea>
	</td>
</tr><tr>
	<td><b>参照先</b></td>
...
<!-- captcha_begin -->
	...
	<td><input type="text" name="captcha" size="8" style="ime-mode:inactive" value="" maxlength="8">
		（右画像の数字を入力）
		<img src="captcha-166.cgi?c0259279717d69554a1114b042c7b24d" class="capt" alt="投稿キー">
		<input type="hidden" name="str_crypt" value="c0259279717d69554a1114b042c7b24d">
	</td>
<!-- captcha_end -->
</tr>
</table>
