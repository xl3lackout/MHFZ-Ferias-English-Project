...
<body>
<div align="center" name="73" id="73">
<h1>掲示板</h1>
<hr width="95%">
...
<tr>
	...
	<td>タイトル</td>
	<td>： <b style="color:#dd0000">カウントダウン</b></td>
</tr><tr>
	<td>投稿日</td>
	<td>： 2019/12/18(Wed) 08:54:29</td>
</tr><tr>
	<td>投稿者</td>
	<td>： <b>しましま</b> </td>
</tr><tr>
...
<blockquote>ＴＯＰの残り時間カウントが１日多くないですか？</blockquote>

<hr width="95%">
<b style="text-indent:2em">- 関連一覧ツリー</b>
（▼ をクリックするとツリーを一括表示します）<br>
<p><ul>
<a href="wforum-119.cgi?mode=relate&no=73&page=30">▼</a> - <a href="wforum-250.cgi?no=73&reno=no&oya=73&mode=read&page=30">カウントダウン</a> - <b>しましま</b> 19/12/18-08:54 <b style="color:#dd0000">No.73</b>
</ul>
</p>
...
<input type="hidden" name="oya" value="73">
<blockquote>
...
<option value="1">非表示
	...
	<td><b>タイトル</b></td>
	<td><input type="text" name="sub" size="38" value="Re: カウントダウン" maxlength="20"></td>
</tr><tr>
	<td colspan="2"><b>メッセージ</b><br>
		<textarea name="message" rows="8" cols="62">
&gt; ＴＯＰの残り時間カウントが１日多くないですか？</textarea>
	</td>
</tr><tr>
	<td><b>参照先</b></td>
...
<!-- captcha_begin -->
	...
	<td><input type="text" name="captcha" size="8" style="ime-mode:inactive" value="" maxlength="8">
		（右画像の数字を入力）
		<img src="captcha-154.cgi?c32c927a727c69554a1114b042c7b447" class="capt" alt="投稿キー">
		<input type="hidden" name="str_crypt" value="c32c927a727c69554a1114b042c7b447">
	</td>
<!-- captcha_end -->
</tr>
</table>
