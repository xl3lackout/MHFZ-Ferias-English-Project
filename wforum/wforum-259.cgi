...
<body>
<div align="center" name="60" id="60">
<h1>掲示板</h1>
<hr width="95%">
...
<tr>
	...
	<td>タイトル</td>
	<td>： <b style="color:#dd0000">thx</b></td>
</tr><tr>
	<td>投稿日</td>
	<td>： 2019/06/21(Fri) 12:48:07</td>
</tr><tr>
	<td>投稿者</td>
	<td>： <b>2鯖</b> </td>
</tr><tr>
...
<blockquote>ここを最初に訪れた時、欲しい情報が細かく全て網羅されていて驚いた記憶が…<br>小部屋さんが無ければMHFの発展はあり得なかったと思います。<br>本当にお世話になりました。</blockquote>

<hr width="95%">
<b style="text-indent:2em">- 関連一覧ツリー</b>
（▼ をクリックするとツリーを一括表示します）<br>
<p><ul>
<a href="wforum-137.cgi?mode=relate&no=60&page=40">▼</a> - <a href="wforum-259.cgi?no=60&reno=no&oya=60&mode=read&page=40">thx</a> - <b>2鯖</b> 19/06/21-12:48 <b style="color:#dd0000">No.60</b>
</ul>
</p>
...
<input type="hidden" name="oya" value="60">
<blockquote>
...
<option value="1">非表示
	...
	<td><b>タイトル</b></td>
	<td><input type="text" name="sub" size="38" value="Re: thx" maxlength="20"></td>
</tr><tr>
	<td colspan="2"><b>メッセージ</b><br>
		<textarea name="message" rows="8" cols="62">
&gt; ここを最初に訪れた時、欲しい情報が細かく全て網羅されていて驚いた記憶が…
&gt; 小部屋さんが無ければMHFの発展はあり得なかったと思います。
&gt; 本当にお世話になりました。</textarea>
	</td>
</tr><tr>
	<td><b>参照先</b></td>
...
<!-- captcha_begin -->
	...
	<td><input type="text" name="captcha" size="8" style="ime-mode:inactive" value="" maxlength="8">
		（右画像の数字を入力）
		<img src="captcha-163.cgi?ce2c917e7c7c69554a1114b042c7b347" class="capt" alt="投稿キー">
		<input type="hidden" name="str_crypt" value="ce2c917e7c7c69554a1114b042c7b347">
	</td>
<!-- captcha_end -->
</tr>
</table>
