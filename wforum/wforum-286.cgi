...
<body>
<div align="center" name="41" id="41">
<h1>掲示板</h1>
<hr width="95%">
...
<tr>
	...
	<td>タイトル</td>
	<td>： <b style="color:#dd0000">Re: 追加報告</b></td>
</tr><tr>
	<td>投稿日</td>
	<td>： 2019/04/29(Mon) 17:24:09</td>
</tr><tr>
	<td>投稿者</td>
	<td>： <b>フェリアス</b> </td>
</tr><tr>
...
<blockquote>剛種系、G系、Z系の混在他修正しました</blockquote>
...
<ul>
<li><a href="wforum-286.cgi?no=41&reno=34&oya=33&mode=read&page=60">Re: 追加報告</a> - <b>フェリアス</b> 19/04/29-17:24  <b style="color:#dd0000">No.41</b>
</li></ul>
</li></ul>
</ul>
</p>
...
<option value="1">非表示
	...
	<td><b>タイトル</b></td>
	<td><input type="text" name="sub" size="38" value="Re^2: 追加報告" maxlength="20"></td>
</tr><tr>
	<td colspan="2"><b>メッセージ</b><br>
		<textarea name="message" rows="8" cols="62">
&gt; 剛種系、G系、Z系の混在他修正しました</textarea>
	</td>
</tr><tr>
	<td><b>参照先</b></td>
...
<!-- captcha_begin -->
	...
	<td><input type="text" name="captcha" size="8" style="ime-mode:inactive" value="" maxlength="8">
		（右画像の数字を入力）
		<img src="captcha-190.cgi?c225957e777a69554a1114b042c7b046" class="capt" alt="投稿キー">
		<input type="hidden" name="str_crypt" value="c225957e777a69554a1114b042c7b046">
	</td>
<!-- captcha_end -->
</tr>
</table>
