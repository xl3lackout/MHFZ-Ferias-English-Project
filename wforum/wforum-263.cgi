...
<body>
<div align="center" name="51" id="51">
<h1>掲示板</h1>
<hr width="95%">
...
<tr>
	...
	<td>タイトル</td>
	<td>： <b style="color:#dd0000">mhf</b></td>
</tr><tr>
	<td>投稿日</td>
	<td>： 2019/06/19(Wed) 16:32:11</td>
</tr><tr>
	<td>投稿者</td>
	<td>： <b>mhf</b> </td>
</tr><tr>
...
<blockquote>このサイトのおかげでｍｈｆライフが充実できました。ありがとうございました。</blockquote>

<hr width="95%">
<b style="text-indent:2em">- 関連一覧ツリー</b>
（▼ をクリックするとツリーを一括表示します）<br>
<p><ul>
<a href="wforum-145.cgi?mode=relate&no=51&page=50">▼</a> - <a href="wforum-263.cgi?no=51&reno=no&oya=51&mode=read&page=50">mhf</a> - <b>mhf</b> 19/06/19-16:32 <b style="color:#dd0000">No.51</b>
<ul>
<li><a href="wforum-264.cgi?no=56&reno=51&oya=51&mode=read&page=50">Re: mhf</a> - <b>名無し</b> 19/06/20-01:03  <span style="color:#008000">No.56</span>
</li></ul>
</ul>
</p>
...
<input type="hidden" name="oya" value="51">
<blockquote>
...
<option value="1">非表示
	...
	<td><b>タイトル</b></td>
	<td><input type="text" name="sub" size="38" value="Re: mhf" maxlength="20"></td>
</tr><tr>
	<td colspan="2"><b>メッセージ</b><br>
		<textarea name="message" rows="8" cols="62">
&gt; このサイトのおかげでｍｈｆライフが充実できました。ありがとうございました。</textarea>
	</td>
</tr><tr>
	<td><b>参照先</b></td>
...
<!-- captcha_begin -->
	...
	<td><input type="text" name="captcha" size="8" style="ime-mode:inactive" value="" maxlength="8">
		（右画像の数字を入力）
		<img src="captcha-167.cgi?c22c9371777069554a1114b042c7b24a" class="capt" alt="投稿キー">
		<input type="hidden" name="str_crypt" value="c22c9371777069554a1114b042c7b24a">
	</td>
<!-- captcha_end -->
</tr>
</table>
