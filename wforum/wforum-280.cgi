...
<body>
<div align="center" name="38" id="38">
<h1>掲示板</h1>
<hr width="95%">
...
<tr>
	...
	<td>タイトル</td>
	<td>： <b style="color:#dd0000">テキスト読み込み時</b></td>
</tr><tr>
	<td>投稿日</td>
	<td>： 2019/04/29(Mon) 10:46:30</td>
</tr><tr>
	<td>投稿者</td>
	<td>： <b>参照でデータ読み込むと・・・</b> </td>
</tr><tr>
	<td>参照先</td>
	<td>： </td>
</tr>
</table>
<blockquote>シミュレートして保存したデータを参照から読み込むと<br>珠一覧、検索含む項目全機能が停止するみたいです<br><br>クローム、エッジ共に同じ症状でした</blockquote>

<hr width="95%">
<b style="text-indent:2em">- 関連一覧ツリー</b>
（▼ をクリックするとツリーを一括表示します）<br>
<p><ul>
<a href="wforum-173.cgi?mode=relate&no=38&page=60">▼</a> - <a href="wforum-280.cgi?no=38&reno=no&oya=38&mode=read&page=60">テキスト読み込み時</a> - <b>参照でデータ読み込むと・・・</b> 19/04/29-10:46 <b style="color:#dd0000">No.38</b>
<ul>
<li><a href="wforum-281.cgi?no=43&reno=38&oya=38&mode=read&page=60">Re: テキスト読み込み時</a> - <b>フェリアス </b> 19/04/29-17:26  <span style="color:#008000">No.43</span>
</li></ul>
</ul>
</p>
...
<input type="hidden" name="oya" value="38">
<blockquote>
...
<option value="1">非表示
	...
	<td><b>タイトル</b></td>
	<td><input type="text" name="sub" size="38" value="Re: テキスト読み込み時" maxlength="20"></td>
</tr><tr>
	<td colspan="2"><b>メッセージ</b><br>
		<textarea name="message" rows="8" cols="62">
&gt; シミュレートして保存したデータを参照から読み込むと
&gt; 珠一覧、検索含む項目全機能が停止するみたいです
&gt; 
&gt; クローム、エッジ共に同じ症状でした</textarea>
	</td>
</tr><tr>
	<td><b>参照先</b></td>
...
<!-- captcha_begin -->
	...
	<td><input type="text" name="captcha" size="8" style="ime-mode:inactive" value="" maxlength="8">
		（右画像の数字を入力）
		<img src="captcha-184.cgi?c024997f727e69554a1114b042c7b04c" class="capt" alt="投稿キー">
		<input type="hidden" name="str_crypt" value="c024997f727e69554a1114b042c7b04c">
	</td>
<!-- captcha_end -->
</tr>
</table>
