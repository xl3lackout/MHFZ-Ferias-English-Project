...
if (location.pathname.indexOf("deconk") !== -1) {
	...
	["Defense",["Vitality","Reflect","Defense","Fortification","Guard","AutoGuard","Breakout"]],
	...
	["Gunner",["Steady Hand","Normal Shot Up","Pierce Shot Up","Pellet Shot Up","Normal Shot Add","Pierce Shot Add","Pellet Shot Add","Crag Shot Add","Cluster Shot Add","Poison Coating Add","Para Coating Add","Sleep Coating Add","Mounting","Gentle Shot","Loading","Rapid Fire","AutoReload","Reload","Recoil","Critical Shot","Precision","Ammo Combiner","Bullet Saver","Sniper","Spacing","HBG Tech","LBG Tech","Bow Tech"]],
	...
	["Protection",["Three Worlds","Hearing Protection","Quake Res","Wind Pressure","AntiTheft","Heat Res","Cold Res","Light Tread","Terrain","Evasion Boost","Evasion","Evade Distance","Passive","Protection","Guts","Absolute Defense"]],
	["Item・Combo",["Combo Expert","Everlasting","WideArea","Whim","Throwing","Strong Arm","Hunter","Cooking","Fish","Combining","Alchemy","Speed Setup","Iron Arm","Knife Throwing"]],
